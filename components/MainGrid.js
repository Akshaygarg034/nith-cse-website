                ...
                <section className={styles.gridSection}>
                    ...
                    <div className={styles.container2}>
                        ...
                        <div className={styles.box5}>
                            ...
                            <video src="https://res.cloudinary.com/dz1vsgxm5/video/upload/v1716225403/nith-cse-website/ancjkzr6jxboae1c60l9.mp4" autoPlay loop muted loading="lazy" playsinline className={styles.boxVideo} />
                            <Fade bottom>
